...
const { toYmd, toHm } = require('./lib/dates');
const { safeReadJson, safeWriteJson } = require('./lib/jsonStore');
const { createAnalyticsRouter } = require('./routes/analytics');
const { createKupecRouter } = require('./routes/kupec');
const { createIzsekovalnaOrodjaRouter } = require('./routes/izsekovalna-orodja');
...
// Kupec API (glej routes/kupec.js)
app.use(createKupecRouter());
// Izsekovalna orodja (glej routes/izsekovalna-orodja.js)
app.use(createIzsekovalnaOrodjaRouter());
...
// Analitika (glej routes/analytics.js)
app.use(createAnalyticsRouter(dbConfig));
